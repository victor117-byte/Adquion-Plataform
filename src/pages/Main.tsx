            ...
            {Array.from({ length: 8 }).map((_, i) => (
              <div key={i} className="flex items-center gap-3 px-3 py-2.5 rounded-lg">
                ...
                <div
                  ...
                  style={{ width: `${55 + (i % 3) * 20}px`, animationDelay: `${i * 60}ms` }}
                />
              </div>
            ))}
          </div>
        ...
        <main className="flex-1 p-6 lg:p-8 space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="rounded-xl border border-border bg-card p-5 space-y-3" style={{ animationDelay: `${i * 80}ms` }}>
          ...
          <div className="rounded-xl border border-border bg-card overflow-hidden">
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex gap-4 px-4 py-3.5 border-b border-border/50 last:border-0" style={{ animationDelay: `${i * 50}ms` }}>
                <div className="h-4 w-[22%] rounded bg-muted animate-pulse" />
